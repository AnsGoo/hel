!(function (e) {
  ...
  function (e, t, n) {
    ...
    (function (e, r) {
      ...
      let o = !1,
        ...
        g = void 0;
      const p =
        "object" === typeof self ? self : "object" === typeof e ? e : {};
      let v = void 0;
      ...
      const y =
        "string"
          === typeof (null
            === (i = null === v || void 0 === v ? void 0 : v.versions)
          || void 0 === i
            ? void 0
      ...
      const _ = o,
        ...
        A = (function () {
          ...
          if (
            "function"
            === typeof (null === v || void 0 === v ? void 0 : v.nextTick)
          )
  ...
  function (e, t, n) {
    ...
    (function (e) {
      ...
      let i;
      if (
        "undefined" !== typeof r.a.vscode
        && "undefined" !== typeof r.a.vscode.process
      ) {
                  ...
                  if (s) {
                    if (
                      ...
                      (h = s.charCodeAt(0)) >= 65
                        && h <= 90
                        && (s =
                          String.fromCharCode(h + 32) + ":" + s.substr(2));
                    }
                    r += n(s, !0);
                  }
                  return (
  ...
  function (e, t, n) {
    ...
    class _ {
      constructor(e) {
        (this.element = e),
          (this.next = _.Undefined),
          (this.prev = _.Undefined);
      }
    }
    _.Undefined = new _(void 0);
    class C {
      constructor() {
        (this._first = _.Undefined),
          (this._last = _.Undefined),
          (this._size = 0);
      }
      get size() {
        return this._size;
        ...
        return (
          this._event
            || (this._event = (e, t, n) => {
              ...
              return (
                n instanceof y ? n.add(a) : Array.isArray(n) && n.push(a), a
              );
            }),
          this._event
        );
      ...
      sendMessage(e, t) {
        ...
        return new Promise((r, i) => {
          (this._pendingReplies[n] = { resolve: r, reject: i }),
            this._send(new P(this._workerId, n, e, t));
        });
      }
      listen(e, t) {
        let n = null;
        const r = new x({
          onFirstListenerAdd: () => {
            (n = String(++this._lastSentReq)),
              ...
              this._send(new R(this._workerId, n, e, t));
          },
          onLastListenerRemove: () => {
            this._pendingEmitters.delete(n),
              this._send(new D(this._workerId, n)),
              (n = null);
          },
        });
        return r.event;
        ...
        this._handler.handleMessage(e.method, e.args).then(
          ...
          (e) => {
            e.detail instanceof Error && (e.detail = o(e.detail)),
              this._send(new V(this._workerId, t, void 0, o(e)));
          }
        );
      }
    ...
    function B(e, t, n) {
      ...
      let o = {};
      for (const s of e)
        U(s) ? (o[s] = i(s)) : j(s) ? (o[s] = n(s, void 0)) : (o[s] = r(s));
      return o;
    }
    class q {
      constructor(e, t) {
      ...
      initialize(e, t, n, r) {
        ...
        return this._requestHandlerFactory
          ? ((this._requestHandler = this._requestHandlerFactory(i)),
            Promise.resolve(L(this._requestHandler)))
          : (t
    ...
    class re {
      ...
      ElementsAreStrictEqual(e, t) {
        ...
        return (
          re._getStrictElement(this._originalSequence, e)
          === re._getStrictElement(this._modifiedSequence, t)
        );
      }
      ...
      ConcatenateChanges(e, t) {
        ...
        }
        {
          ...
          return (
            te.Copy(e, 0, n, 0, e.length),
            te.Copy(t, 0, n, e.length, t.length),
            n
          );
        }
      }
      ...
      for (let l = 0; l <= e.length; ++l) {
        ...
        if (r(u)) {
          if (s === l - 1 || 1 === a);
            ...
            i.length > 0
              ? (i += "".concat(n).concat(e.slice(s + 1, l)))
              : (i = e.slice(s + 1, l)),
              (o = l - s - 1);
          (s = l), (a = 0);
        } else 46 === u && -1 !== a ? ++a : (a = -1);
    ...
    function he(e, t) {
      if (null === t || "object" !== typeof t)
        throw new oe("pathObject", "Object", t);
    ...
    const fe = {
            ...
            if (((i = !0), ae(e.charCodeAt(1)))) {
              ...
              if (i < t && i !== o) {
                ...
                if (i < t && i !== o) {
                  for (o = i; i < t && !ae(e.charCodeAt(i)); ) i++;
                  if (i === t)
                    return "\\\\".concat(s, "\\").concat(e.slice(o), "\\");
                  i !== o
                    && ((n = "\\\\".concat(s, "\\").concat(e.slice(o, i))),
                    (r = i));
                }
              }
            } else r = 1;
        ...
        isAbsolute(e) {
          ...
          return (
            ae(n)
            || (t > 2 && le(n) && 58 === e.charCodeAt(1) && ae(e.charCodeAt(2)))
          );
        },
        join() {
          if (0 === arguments.length) return ".";
        ...
        dirname(e) {
          ...
          if (ae(i)) {
            ...
            le(i)
              && 58 === e.charCodeAt(1)
              && ((n = t > 2 && ae(e.charCodeAt(2)) ? 3 : 2), (r = n));
          let o = -1,
            s = !0;
          for (let a = t - 1; a >= r; --a)
      ...
      de = {
        resolve() {
          ...
          return (
            (e = ce(e, !t, "/", ue)), t ? "/".concat(e) : e.length > 0 ? e : "."
          );
        },
        normalize(e) {
        ...
        isAbsolute: (e) => (
          se(e, "path"), e.length > 0 && 47 === e.charCodeAt(0)
        ),
        join() {
          if (0 === arguments.length) return ".";
          let e;
    ...
    class _e {
      ...
      static file(e) {
        ...
        if ((S.d && (e = e.replace(/\\/g, ye)), e[0] === ye && e[1] === ye)) {
          ...
          -1 === n
            ? ((t = e.substring(2)), (e = ye))
            : ((t = e.substring(2, n)), (e = e.substring(n) || ye));
        }
        ...
        if (e) {
          if (e instanceof _e) return e;
          {
            ...
            return (
              ...
              (t._fsPath = e._sep === Ce ? e.fsPath : null),
              t
            );
          }
        }
    ...
    function Ne(e) {
      ...
      for (let n = 0; n < e.length; n++) {
        ...
        35 === r || 63 === r
          ? (void 0 === t && (t = e.substr(0, n)), (t += Ae[r]))
          : void 0 !== t && (t += e[n]);
      }
      return void 0 !== t ? t : e;
    }
      ...
      static createFromDiffResult(e, t, n, r, i, o, s) {
        ...
        if (
          ...
          for (let e = 0, t = u.length; e < t; e++)
            h.push(Ve.createFromDiffChange(u[e], o, a));
        }
    ...
    class Fe {
      ...
      _pushTrimWhitespaceCharChange(e, t, n, r, i, o, s) {
        ...
        let a = void 0;
        this.shouldComputeCharChanges && (a = [new Ve(t, n, t, r, i, o, i, s)]),
          e.push(new Re(t, t, i, i, a));
      }
      _mergeTrimWhitespaceCharChange(e, t, n, r, i, o, s) {
        ...
        return (
          ...
          this.shouldComputeCharChanges
            && u.charChanges
            && u.charChanges.push(new Ve(t, n, t, r, i, o, i, s)),
          !0)
        );
      }
    }
    ...
    class Ge {
      constructor(e) {
        ...
        (this._defaultValue = t),
          (this._asciiMap = Ge._createAsciiMap(t)),
          (this._map = new Map());
      }
    ...
    ((rt = nt || (nt = {})).isCancellationToken = function (e) {
      ...
      (rt.None = Object.freeze({
        isCancellationRequested: !1,
        onCancellationRequested: N.None,
      })),
      (rt.Cancelled = Object.freeze({
        isCancellationRequested: !0,
        onCancellationRequested: tt,
      }));
    class it {
      constructor() {
      ...
      get onCancellationRequested() {
        return this._isCancelled
          ? tt
          : (this._emitter || (this._emitter = new x()), this._emitter.event);
      }
      dispose() {
    ...
    class rn extends class {
        ...
        for (const n of t)
          this._acceptDeleteRange(n.range),
            this._acceptInsertText(
              new ke(n.range.startLineNumber, n.range.startColumn),
              n.text
            );
      ...
      getWordAtPosition(e, t) {
        let n = (function e(t, n, r, i) {
          let o =
            arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : $e;
        ...
        return n
          ? new Oe(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn)
          : null;
      }
      words(e) {
        const t = this._lines,
      ...
      computeMoreMinimalEdits(e, t) {
        return nn(this, void 0, void 0, function* () {
          ...
          t = t.slice(0).sort((e, t) => {
            if (e.range && t.range)
              return Oe.compareRangesUsingStarts(e.range, t.range);
            return (e.range ? 0 : 1) - (t.range ? 0 : 1);
          });
          for (let { range: e, text: o, eol: s } of t) {
            if (("number" === typeof s && (i = s), Oe.isEmpty(e) && !o))
              continue;
            ...
            if (e)
              for (let n of e.words(o))
                if (
                  n !== t
                  && isNaN(Number(n))
                  && (s.add(n), s.size > on._suggestionsLimit)
                )
                  break e;
          }
    ...
    function un(e, t) {
      ...
      function d() {
        ...
        switch (t) {
          ...
          case 45:
            if (
              ((i += String.fromCharCode(t)), ++r === n || !hn(e.charCodeAt(r)))
            )
              return (s = 16);
          case 48:
          case 49:
            ...
            return (
              (i += (function () {
                ...
                if (r < e.length && 46 === e.charCodeAt(r)) {
                  if (!(++r < e.length && hn(e.charCodeAt(r))))
    ...
    function fn(e, t, n) {
      var r, i, o, s, a;
      if (t) {
        for (s = t.offset, a = s + t.length, o = s; o > 0 && !mn(e, o - 1); )
          o--;
      ...
      for (; 17 !== b; ) {
        for (
          var C = d.getTokenOffset() + d.getTokenLength() + o,
            S = p(),
            A = "",
            E = !1;
          !h && (12 === S || 13 === S);
        ...
        17 === S && (A = n.insertFinalNewline ? c : ""),
          y(A, C, d.getTokenOffset() + o),
          (b = S);
      }
      return v;
    }
    ...
    !(function (e) {
      ...
      (function (e) {
        (e.create = function (e, t) {
          return (
            e === Number.MAX_VALUE && (e = yn.MAX_VALUE),
      ...
      ((Cn = _n || (_n = {})).create = function (e, t, n, r) {
        if (
          ...
          return { start: bn.create(e, t), end: bn.create(n, r) };
        ...
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              Vr.defined(t)
              && _n.is(t.range)
              && (Vr.string(t.uri) || Vr.undefined(t.uri))
            );
          });
      })(Sn || (Sn = {})),
      (function (e) {
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              && (_n.is(t.targetSelectionRange)
                || Vr.undefined(t.targetSelectionRange))
              && (_n.is(t.originSelectionRange)
                || Vr.undefined(t.originSelectionRange))
            );
          });
      })(An || (An = {})),
      (function (e) {
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              Vr.numberRange(t.red, 0, 1)
              && Vr.numberRange(t.green, 0, 1)
              && Vr.numberRange(t.blue, 0, 1)
              && Vr.numberRange(t.alpha, 0, 1)
            );
          });
      })(En || (En = {})),
      (function (e) {
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              && (Vr.undefined(t.additionalTextEdits)
                || Vr.typedArray(t.additionalTextEdits, Vn.is))
            );
          });
      })(wn || (wn = {})),
      (function (e) {
      ...
      (function (e) {
        (e.create = function (e, t, n, r, i) {
          ...
          return (
            Vr.defined(n) && (o.startCharacter = n),
            Vr.defined(r) && (o.endCharacter = r),
            Vr.defined(i) && (o.kind = i),
            o
          );
        }),
          (e.is = function (e) {
            ...
            return (
              ...
              && Vr.uinteger(t.startLine)
              && (Vr.undefined(t.startCharacter)
                || Vr.uinteger(t.startCharacter))
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              && (Vr.integer(n.code)
                || Vr.string(n.code)
                || Vr.undefined(n.code))
              && (Vr.undefined(n.codeDescription)
                || Vr.string(
              ...
              && (Vr.undefined(n.relatedInformation)
                || Vr.typedArray(n.relatedInformation, Tn.is))
            );
          });
      })(Mn || (Mn = {})),
      (function (e) {
      ...
      (function (e) {
        (e.replace = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              Vr.objectLiteral(t) && Vr.string(t.newText) && _n.is(t.range)
            );
          });
      })(Vn || (Vn = {})),
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              && Vr.objectLiteral(t)
              && Vr.string(t.label)
              && (Vr.boolean(t.needsConfirmation)
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              Vr.defined(t) && ir.is(t.textDocument) && Array.isArray(t.edits)
            );
          });
      })(Kn || (Kn = {})),
      (function (e) {
            ...
            return (
              ...
              && (void 0 === t.options
                || ((void 0 === t.options.overwrite
                  || Vr.boolean(t.options.overwrite))
                  && (void 0 === t.options.ignoreIfExists
                    || Vr.boolean(t.options.ignoreIfExists))))
            ...
            return (
              ...
              && (void 0 === t.options
                || ((void 0 === t.options.recursive
                  || Vr.boolean(t.options.recursive))
                  && (void 0 === t.options.ignoreIfNotExists
                    || Vr.boolean(t.options.ignoreIfNotExists))))
              && (void 0 === t.annotationId || Fn.is(t.annotationId))
            );
          });
      })(Bn || (Bn = {})),
          ...
          return (
            ...
            && (void 0 === t.documentChanges
              || t.documentChanges.every(function (e) {
                return Vr.string(e.kind)
                  ? jn.is(e) || Un.is(e) || Bn.is(e)
                  : Kn.is(e);
              }))
          );
        };
      ...
      Object.defineProperty(e.prototype, "edit", {
          ...
          if (ir.is(e)) {
            ...
            if (!(r = this._textEditChanges[t.uri])) {
              ...
              this._workspaceEdit.documentChanges.push(n),
                (r = new Ir(i, this._changeAnnotations)),
        ...
        (e.prototype.createFile = function (e, t, n) {
          ...
          if (
            ...
            void 0 === r
              ? (i = jn.create(e, n))
              : ((o = Fn.is(r) ? r : this._changeAnnotations.manage(r)),
                (i = jn.create(e, n, o))),
        ...
        (e.prototype.renameFile = function (e, t, n, r) {
          ...
          if (
            ...
            void 0 === i
              ? (o = Un.create(e, t, r))
              : ((s = Fn.is(i) ? i : this._changeAnnotations.manage(i)),
                (o = Un.create(e, t, r, s))),
    ...
    !(function (e) {
        ...
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              Vr.defined(t)
              && Vr.string(t.uri)
              && (null === t.version || Vr.integer(t.version))
            );
          });
      })(ir || (ir = {})),
      (function (e) {
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            ...
            return (
              Vr.defined(t)
              && Vr.string(t.uri)
              && Vr.string(t.languageId)
              && Vr.integer(t.version)
              && Vr.string(t.text)
            );
          });
      })(or || (or = {})),
      ...
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              t && Vr.string(t.newText) && _n.is(t.insert) && _n.is(t.replace)
            );
          });
      })(hr || (hr = {})),
      (function (e) {
      ...
      (function (e) {
        e.is = function (e) {
          ...
          return (
            ...
            && (ar.is(t.contents)
              || gr.is(t.contents)
              || Vr.typedArray(t.contents, gr.is))
      ...
      (function (e) {
        e.create = function (e, t) {
          ...
          var i = { label: e };
          return (
            Vr.defined(t) && (i.documentation = t),
            Vr.defined(n) ? (i.parameters = n) : (i.parameters = []),
            i
          );
        };
      })(yr || (yr = {})),
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              Vr.defined(t)
              && Vr.typedArray(t.diagnostics, Mn.is)
              && (void 0 === t.only || Vr.typedArray(t.only, Vr.string))
            );
          });
      })(wr || (wr = {})),
      (function (e) {
        ...
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              Vr.defined(t)
              && _n.is(t.range)
              && (Vr.undefined(t.command) || Pn.is(t.command))
            );
          });
      })(Lr || (Lr = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              Vr.defined(t)
              && Vr.uinteger(t.tabSize)
              && Vr.boolean(t.insertSpaces)
            );
          });
      })(Tr || (Tr = {})),
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              Vr.defined(t)
              && _n.is(t.range)
              && (Vr.undefined(t.target) || Vr.string(t.target))
            );
          });
      })(kr || (kr = {})),
      (function (e) {
              ...
              if (e.isIncremental(o)) {
                ...
                if (c - l === f.length)
                  ...
                  f.length < 1e4
                    ...
                    : (this._lineOffsets = h =
                        h.slice(0, l + 1).concat(f, h.slice(c + 1)));
    ...
    !(function (e) {
      ...
      ((Kr || (Kr = {})).LATEST = {
        textDocument: {
          completion: {
            completionItem: {
              documentationFormat: [sr.Markdown, sr.PlainText],
    ...
    var ai = (function () {
        ...
        return (
          ...
          (e.prototype.include = function (e) {
            return (
              (-1 === this.focusOffset || fi(e, this.focusOffset))
              && e !== this.exclude
            );
          }),
            ...
            !(function (e, t, n, r) {
              ...
              if (t.patternProperties)
                for (
                  ...
                  for (
                    var S = C[_], A = tr(S), E = 0, N = o.slice(0);
                    E < N.length;
                    E++
                  ) {
                    h = N[E];
              ...
              if ("object" === typeof t.additionalProperties)
                for (var w = 0, x = o; w < x.length; w++) {
                  ...
                  if ((k = i[h])) {
                    b = new li();
                    mi(k, t.additionalProperties, b, r),
              ...
              if (Array.isArray(t.items)) {
                for (var i = t.items, o = 0; o < i.length; o++) {
                  var s = si(i[o]),
                    a = new li();
                  (f = e.items[o])
                    ? (mi(f, s, a, r), n.mergePropertyMatch(a))
                ...
                if (e.items.length > i.length)
                  if ("object" === typeof t.additionalItems)
                    for (var u = i.length; u < e.items.length; u++) {
                      a = new li();
                      mi(e.items[u], t.additionalItems, a, r),
    ...
    function gi(e, t) {
      ...
      function c() {
        switch (o.getTokenError()) {
          case 4:
            return (
              l(
                Xr("InvalidUnicode", "Invalid unicode sequence in string."),
                Dr.InvalidUnicode
              ),
              !0
            );
          ...
          case 3:
            return (
              l(
                Xr("UnexpectedEndOfNumber", "Unexpected end of number."),
                Dr.UnexpectedEndOfNumber
              ),
              !0
            );
          case 1:
            return (
              l(
                Xr("UnexpectedEndOfComment", "Unexpected end of comment."),
                Dr.UnexpectedEndOfComment
              ),
              !0
            );
          case 2:
            return (
              l(
                Xr("UnexpectedEndOfString", "Unexpected end of string."),
                Dr.UnexpectedEndOfString
              ),
              !0
            );
          case 6:
      ...
      function d(t, n) {
        ...
        if (!i) {
          ...
          l(
            Xr("DoubleQuotesExpected", "Property keys must be doublequoted"),
            Dr.Undefined
          );
        ...
        return h
          ...
          : l(
              Xr("ValueExpected", "Value expected"),
              Dr.ValueExpected,
              r,
              [],
              [2, 5]
              ...
              for (var n = !1; 4 !== o.getToken() && 17 !== o.getToken(); ) {
                if (5 === o.getToken()) {
                  ...
                  if ((a(), 4 === o.getToken())) {
                    n
                      && u(
                        Xr("TrailingComma", "Trailing comma"),
                        Dr.TrailingComma,
                        r,
                        r + 1
                      );
                  ...
                  n
                    && l(
                      Xr("ExpectedComma", "Expected comma"),
                      Dr.CommaExpected
                    );
                var i = g(t);
                i
                  ? t.items.push(i)
                  : l(
                      Xr("PropertyExpected", "Value expected"),
                      Dr.ValueExpected,
                      void 0,
                      [],
                      [4, 5]
            ...
            if (1 === o.getToken()) {
              ...
              for (var r = !1; 2 !== o.getToken() && 17 !== o.getToken(); ) {
                if (5 === o.getToken()) {
                  r
                    || l(
                      Xr("PropertyExpected", "Property expected"),
                      Dr.PropertyExpected
                    );
              ...
              return 2 !== o.getToken()
                ? l(
                    Xr("ExpectedCloseBrace", "Expected comma or closing brace"),
                    Dr.CommaOrCloseBraceExpected,
                    t
                  )
                : h(t, !0);
            }
            ...
            if (11 === o.getToken()) {
              ...
              if (0 === o.getTokenError()) {
                ...
                try {
                  ...
                  if (!Xn(r))
                    return l(
                      Xr("InvalidNumberFormat", "Invalid number format."),
                      Dr.Undefined,
                      t
                    );
                  t.value = r;
      ...
      return (
        17 !== a()
          && ((p = g(p))
            ? 17 !== o.getToken()
              && l(
                Xr("End of file expected", "End of file expected."),
                Dr.Undefined
              )
            : l(
                Xr(
      ...
      vi = (function () {
        ...
        return (
              ...
              d = {
                add: function (e) {
                  ...
                  if (n)
                    ...
                    l
                      && void 0 !== e.insertText
                      && (e.textEdit = Vn.replace(l, e.insertText)),
                      (e.label = t),
                      (f[t] = e),
                      i.items.push(e);
                  }
          ...
          (e.prototype.findItemAtOffset = function (e, t, n) {
            for (
              var r = Wn(t.getText(), !0), i = e.items, o = i.length - 1;
              o >= 0;
              o--
            ) {
              var s = i[o];
          ...
          (e.prototype.fromMarkup = function (e) {
            if (e && this.doesSupportMarkdown())
              return { kind: sr.Markdown, value: e };
          }),
          (e.prototype.doesSupportMarkdown = function () {
            if (!Zn(this.supportsMarkdown)) {
              ...
              this.supportsMarkdown =
                ...
                && -1
                  !== e.completionItem.documentationFormat.indexOf(sr.Markdown);
            }
                    ...
                    if (
                      ...
                      e.schema.markdownEnumDescriptions
                        ...
                        : e.schema.enumDescriptions
                          && (s = bi(e.schema.enumDescriptions[t])),
                        s
              ...
              o || (i = i.substring(1)),
                i.length > 0
                  ...
                  this.globWrappers.push({
                    regexp: Ci("**/" + i, { extended: !0, globstar: !0 }),
                    include: o,
                  }));
            }
            this.uris = t;
      ...
      xi = (function () {
        ...
        return (
          ...
          (e.prototype.getMatchingSchemas = function (e, t, n) {
            if (n) {
              var r =
                n.id || "schemaservice://untitled/matchingSchemas/" + Li++;
              return this.resolveSchemaContent(new Ni(n), r, {}).then(function (
                e
              ) {
        ...
        return (
          (e.prototype.configure = function (e) {
            e
              ...
              (this.commentSeverity = e.allowComments ? void 0 : kn.Error));
          }),
          (e.prototype.doValidation = function (e, t, n, r) {
            ...
            var o = [],
              ...
              u = function (r) {
                var s = (null === n || void 0 === n ? void 0 : n.trailingCommas)
                    ? Pi(n.trailingCommas)
                    : kn.Error,
                  u = (null === n || void 0 === n ? void 0 : n.comments)
                    ? Pi(n.comments)
                    : i.commentSeverity,
                  l = (null === n || void 0 === n ? void 0 : n.schemaValidation)
                    ? Pi(n.schemaValidation)
                    : kn.Warning,
                  c = (null === n || void 0 === n ? void 0 : n.schemaRequest)
                    ? Pi(n.schemaRequest)
                    : kn.Warning;
                if (r) {
                  ...
                  (function e(t) {
                    ...
                    (function e(t) {
                      if (t && "object" === typeof t) {
                        if (Yn(t.allowTrailingCommas))
                          return t.allowTrailingCommas;
                        var n = t;
                        if (Yn(n.allowsTrailingCommas))
            ...
            if (r) {
              ...
              return this.jsonSchemaService
                .resolveSchemaContent(new Ni(r), l, {})
                .then(function (e) {
                  return u(e);
                });
            }
        ...
        (e.prototype.findDocumentSymbols = function (e, t, n) {
          ...
          if (
            ("vscode://defaultsettings/keybindings.json" === s
              || er(s.toLowerCase(), "/user/keybindings.json"))
            && "array" === i.type
          ) {
    ...
    for (var Bi in ji.schemas) {
      ...
      for (var Wi in qi.properties) {
        ...
        $i
          ? (Hi.description = $i)
          : console.log(Wi + ": localize('schema.json." + Wi + '\', "")');
      }
    }
    function zi(e, t) {
      var n = [],
        ...
        switch (a) {
          ...
          case 13:
            ...
            1 === s.getTokenError() && f + 1 < e.lineCount
              ...
              : f < d
                && (u({ startLine: f, endLine: d, kind: xn.Comment }), (o = f));
            break;
          case 12:
            var m = e
              .getText()
            ...
            if (m) {
              ...
              if (m[1]) {
                ...
                for (var g = i.length - 1; g >= 0 && i[g].kind !== xn.Region; )
                  g--;
                if (g >= 0) {
                  l = i[g];
                  (i.length = g),
        ...
        return (
          ...
          (e.prototype._getTextDocument = function (e) {
            for (
              ...
              var r = n[t];
              if (r.uri.toString() === e)
                return Fr.create(e, this._languageId, r.version, r.getValue());
            }
            return null;
          }),
          e
    ...
    function oo(e) {
      for (var t = [], n = 0, r = e; n < r.length; n++) {
        ...
        0 === i.length
          ...
          || (2 === i.length && i.charCodeAt(0) === io && i.charCodeAt(1) === io
            ? t.pop()
            : t.push(i));
      }
