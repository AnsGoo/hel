        ...
        !(function (e) {
          try {
            if (Object.keys(e).length > 2)
              return void (e.default || (e.default = e));
            const t = e.default;
            t && Object.assign(e, t);
          } catch (t) {
    ...
    746: function (e, t, a) {
      ...
      function v(e) {
        ...
        return (
          ...
          || (Array.isArray(e)
            ? !!r && 0 === e.length
            : "object" === typeof e && !!n && 0 === Object.keys(e).length)
        );
      }
      function k(e, t) {
      ...
      function _e(e) {
        ...
        t
          ? Se("".concat(window.top.location.origin, "/#").concat(e))
          : ((Ce = e), ge.history.push(e));
      }
      function Se(e) {
        let t = e;
      ...
      function Ae(e) {
        ...
        return r
          ? "https://some-devops/console/pipeline/"
              .concat(t, "/")
              .concat(a, "/detail/")
              .concat(n)
          : "";
      ...
      function Le(e) {
        return (
          console.log("get avatar for name ".concat(e)),
          "https://avatars.githubusercontent.com/u/7334950?v=4&size=64"
        );
      }
      var Ie = function () {
          let e = {};
      ...
      function Fe(e, t, a, n, r) {
        if (!Re.includes(e))
          return (
            console.error("messageService call invalid method[".concat(e, "]")),
            t("ignored")
          );
        ...
        Xe = (e, t) => {
          ...
          return t
            ? a.includes("?")
              ...
              : "".concat(n, "?").concat(fe.a.stringify(t))
            : (e.startsWith("http")
                || (n = "".concat(window.top.location.origin).concat(n)),
              n);
        },
        Ze = (e) => {
          const t = Date.now();
          return e.includes("?")
            ? "".concat(e, "&_rt=").concat(t)
            : "".concat(e, "?_rt=").concat(t);
        };
      function Qe(e, t) {
        if (!t) {
        ...
        try {
          if (((n.url = Xe(n.url)), "jsonp" === n.method)) {
            return t(
              await Pe()({
                type: "jsonp",
                url: "".concat(n.url, "?").concat(fe.a.stringify(n.data)),
              })
            );
          }
          ("get" !== n.method && n.method)
            || ((n.params = n.data), delete n.data),
            (n.withCredentials = !0);
        ...
        (at.multiGet = async function (e) {
          ...
          try {
            ...
            const n = e.map((e) => Xe(e, "")),
              r =
                void 0 !== t.failStrategy
                  ? t.failStrategy
                  : Ne.a.const.KEEP_ALL_BEEN_EXECUTED;
            return (
              await Ne.a.multiGet(
                n,
                Object(f.a)(Object(f.a)({}, Ye), { failStrategy: r })
              )
            ).map((e, t) => $e(e, n[t], a));
          } catch (r) {
            return Qe(r, n);
          ...
          try {
            ...
            const n =
              void 0 !== t.failStrategy
                ...
                : Ne.a.const.KEEP_ALL_BEEN_EXECUTED;
            return (
              await Ne.a.multiPost(
                e,
                Object(f.a)(Object(f.a)({}, Ye), { failStrategy: n })
              )
            ).map((t, n) => $e(t, e[n].url, a));
          } catch (r) {
            return Qe(r, n);
          }
        });
      ...
      function ct(e) {
        ...
        return (
          t.gray_users
            && "object" === typeof t.gray_users
            && (t.gray_users = JSON.stringify(t.gray_users)),
          t.owners
            && "object" === typeof t.owners
            && (t.owners = JSON.stringify(t.owners)),
          t
        );
      }
      async function it() {
      ...
      async function pt(e) {
        ...
        return await nt.post(
          "/api/v1/app/info/createSubApp?timestamp="
            .concat(t, "&nonce=")
            .concat(a),
          ct(e)
        );
      ...
      async function ut(e) {
        const t = Date.now(),
          ...
          n = "/api/v1/app/info/updateSubApp?timestamp="
            .concat(t, "&nonce=")
            .concat(a);
      ...
      async function mt(e, t, a) {
        const n = a ? "1" : "0";
        return await nt.get(
          "/api/v1/app/info/getSubAppVersion?name="
            .concat(e, "&ver=")
            .concat(t, "&content=")
            .concat(n)
        );
      ...
      async function Mt() {
        ...
        return await nt.get(
          "/api/v1/classInfo/list?timestamp=".concat(e, "&nonce=").concat(t)
        );
      }
      function Tt(e) {
      ...
      function Pt(e, t) {
        ...
        return ""
          .concat(a, "/openapi/v1/app/info/getSubAppAndItsFullVersion?name=")
          .concat(e)
          .concat(n);
      }
      function zt(e, t) {
        const { prefix: a, versionQuery: n } = Bt(t);
        return ""
          .concat(a, "/openapi/v1/app/info/getSubAppAndItsVersion?name=")
          .concat(e)
          .concat(n);
      }
      function Rt(e, t) {
      ...
      async function Ht(e, t, a) {
        ...
        try {
          ...
          if (!i.is_local_render) {
            const e =
              i.render_app_host
              || "".concat(window.location.origin, "/page/").concat(i.name);
          ...
          let g =
            (function () {
              ...
              return (
                (e && fe.a.parse(e, { ignoreQueryPrefix: !0 })._appv) || ""
              );
            })() || s;
          ...
          if (i.is_back_render) {
            const e = (e) => {
              window.top.history.replaceState(
                ...
                e
                  && window.top.open(
                    "".concat(window.top.location.origin, "/page/").concat(e)
                  );
            };
            return (
              n(),
          ...
          (r[g] = h),
            Te.a.save("__leah_sub_app_name__", e),
            await a.setState({ activeApp: e, appVerId2detail: r, loading: !1 });
          const b = o[c];
      ...
      async function Ut(e, t) {
        const { user: a } = t.userInfo,
          {
            ...
            let n = "/api/v1/app/info/combine3api?timestamp="
              .concat(t, "&name=")
              .concat(a);
            n = lt(n, a, t);
        ...
        return {
          starAppNames: n,
          visitAppNames: r,
          userMarkedList: l.markedList,
        };
      }
      async function Gt(e, t, a) {
        return (
          await a.setState({
            userInfo: { user: "test-user", icon: "", login: !0 },
          }),
          await a.dispatch(Ut),
      ...
      async function Kt(e) {
        try {
          const t = await (async function (e) {
            return await nt.get(
              "/api/v1/app/info/updateUserVisitApp?name=".concat(e)
            );
          })(e);
          return (
            Lt.latestVisit.setState({ needRefresh: !0 }), { visitAppNames: t }
          );
        } catch (t) {}
      }
      async function Wt(e, t, a) {
        ...
        window.top.history.replaceState({}, n, "/".concat(n)),
          window.top.location.reload(
            "".concat(window.top.location.origin, "/").concat(n)
          );
      }
      function qt(e, t) {
        const a = ve(),
        ...
        ((n && ("__hub" === a || "" === a)) || (!n && "__hub" !== a))
          && (console.log(
            "[hel] redirect to ".concat(window.top.location.origin)
          ),
          (window.top.location.href = ""
            .concat(window.top.location.origin)
            .concat(window.top.location.pathname)),
          window.top.location.reload());
      }
      function Jt(e, t) {
      ...
      function oa(e) {
        ...
        return (
          t && (o.where.name = t),
          void 0 !== l && (o.where.is_top = l),
          a && (o.where.create_by = a),
          o
        );
      }
      function ca() {
      ...
      async function Ca() {
        ...
        if ((await a.setState({ page: p, size: u }), "appStore" === a.module)) {
          if (
            ("test" === n
              ? (m.where.is_test = 1)
              : "prod" === n && (m.where.is_test = 0),
            ["name", "name_exact"].includes(c) && r)
          ) {
            const e = r.replace(/ /g, "");
        ...
        try {
          ...
          if (
            (await a.dispatch(ka, { loading: !1, page: p }),
            0 === l.length && p > 1)
          )
            return (
              Ke("\u6ca1\u6709\u66f4\u591a\u5b50\u5e94\u7528\u4e86", 1), null
          ...
          if (
            ("appStore" !== a.module && l.sort(ua((e) => e.app_group_name)),
            Object.assign(d, c),
            ha(c),
            o)
          ) {
          ...
          try {
            await (async function (e) {
              ...
              const a = await nt.get(
                "/api/v1/app/info/updateUserStarApp?name="
                  .concat(e, "&star=")
                  .concat(t ? 1 : 0)
              );
              return a;
      ...
      async function Sa(e, t, a) {
        ...
        r
          ...
          await (async function (e) {
            return await nt.get(
              "/api/v1/app/info/delUserVisitApp?name=".concat(e)
            );
          })(e),
      ...
      function xa(e, t) {
        ...
        if (r >= 0)
          return delete a[e], n.splice(r, 1), { name2SubApp: a, subApps: n };
      }
      function Aa(e) {
        const t = ke();
        Vt([L, I, M, B], t).forEach((t) => {
          const a = ue[t];
          t === L || t === I || t === B
            ? Lt[a].setState({ needRefresh: !0 })
            : Lt.appStore.updateSubAppViewModel(e);
        });
      }
      function La(e, t) {
        let { appName: a } = e,
      ...
      async function Ia(e, t, a) {
        ...
        const o = await ut(e);
        return 0 !== parseInt(o.code, 10)
          ? (Ke(o.msg), !1)
          : (await a.dispatch(va), !0);
      }
      ...
      function Ta(e, t, a) {
        ...
        const o = r[e.name];
        return (
          o ? Object.assign(o, e) : (r[e.name] = e),
          { subApps: n, name2SubApp: r }
        );
      }
      async function Va(e, t, a) {
      ...
      async function Ua(e, t, a) {
        ...
        await a.dispatch(Ha, {
          tableId: r,
          toMod: { loading: !0, current: n, lockId: Date.now() },
        }),
      ...
      async function Ka(e, t, a) {
        ...
        await a.dispatch(Ha, {
          tableId: n,
          toMod: { loading: !0, pageSize: r, lockId: Date.now() },
        }),
      ...
      async function qa(e, t, a) {
        ...
        if (!m)
          return void (await a.dispatch(Ha, {
            tableId: n,
            toMod: { loading: !1 },
          }));
        ...
        u && (y = p.concat(b)),
          await a.dispatch(Ha, {
            tableId: n,
            toMod: { list: y, total: h, hasMore: f, loading: !1 },
          });
      }
      Object(h.configure)("GeneralTable", {
        state: () => ({ meta: {} }),
        reducer: p,
      });
      var Ja,
      ...
      const Xa = Object($a.c)(za.a)(
        ...
        tn = (e) => {
          const {
              tid: t,
              fetchAfterMounted: a = !0,
              hasMoreMode: n = !1,
              fetchFn: r,
              pageSizeOptions: l = ["50", "100", "200"],
            } = e.props,
            { ccUniqueKey: o } = e;
          if (!e.state.meta[t]) {
          ...
          e.on([Za, t], async (a) => {
            const n = a || r;
            await e.mr.clearTable({ tableId: t }, o),
              await e.mr.handlePageCurrentChange(
                { tableId: t, current: 1, fetchFn: n },
                o
              );
          }),
            e.on([Qa, t], () => {
            ...
            e.on([en, t], (a) => {
              const n = a || r,
                l = e.state.meta[t];
              e.mr.handlePageCurrentChange(
                { tableId: t, current: l.current, fetchFn: n },
                o
              );
            }),
            e.effect(
              () => (a && c(1), () => e.mr.clearTable({ tableId: t }, o)),
              []
            );
          const c = (a) => {
            const { fetchFn: n } = e.props;
            e.mr.handlePageCurrentChange(
              { tableId: t, current: a, fetchFn: n },
              o
            );
          };
          return {
            ...
            handelPageSizeChange: (a, n) => {
              ...
              e.mr.handlePageSizeChange(
                { tableId: t, pageSize: n, fetchFn: r },
                o
              );
            },
            handleNextPage: () => {
      ...
      var an = bt.a.memo(function (e) {
        const { state: t, settings: a } = Object(h.useConcent)({
            module: "GeneralTable",
            setup: tn,
            props: e,
          }),
          ...
          {
            handelPageSizeChange: y,
            handlePageCurrentChange: w,
            handleNextPage: v,
            pageSizeOptions: k,
          } = a,
        ...
        return bt.a.createElement(
          ...
          c
            ? i && !E
              ? bt.a.createElement(
                  Ba.a,
                  { disabled: !0, style: { width: "100%" } },
                  "\u6ca1\u6709\u66f4\u591a\u4e86"
                )
              : bt.a.createElement(
                  Ba.a,
                  { onClick: v, style: { width: "100%" } },
                  "\u52a0\u8f7d\u66f4\u591a"
                )
            : C
        );
      ...
      async function on(e) {
        const t = await (async function (e) {
            return await nt.get(
              "/api/v1/app/info/getAppGlobalData?name=".concat(e)
            );
          })(e),
          {
      ...
      async function pn(e, t) {
        const { subApp: a, listMode: n, globalMarkedList: r } = t,
          ...
          s = await (async function (e) {
            return await nt.post(
              "/api/v1/app/version/countSubAppVersionListByName",
              { name: e }
            );
          })(i);
        let p = [];
            ...
            ? ((h = s.total),
              (g = await (async function (e, t, a) {
                const n = Date.now(),
                  r = t - 1;
                let l =
                  "/api/v1/app/version/getSubAppVersionListByName?timestamp=".concat(
                    n
                  );
                const o = rt(
                  ""
                ...
                return (
                  (l = "".concat(l, "&nonce=").concat(o)),
                  await nt.post(l, { name: e, page: r, size: a })
                );
              })(i, o, c)),
      ...
      async function un() {
        ...
        try {
          if ("online" === r) {
            if (l.online_version === i)
              return void He("\u7ebf\u4e0a\u7248\u672c\u65e0\u53d8\u5316", 2);
            ...
            if ("gray" !== r)
              return void Ke("\u672a\u77e5\u7684 changeMode ".concat(r), 2);
            if ((l.build_version === i) & (1 === l.is_in_gray))
              return void He("\u7070\u5ea6\u7248\u672c\u65e0\u53d8\u5316", 2);
      ...
      async function fn(e, t, a) {
        ...
        try {
          ...
          const e = await ut({
            id: n.id,
            name: n.name,
            online_version: n.build_version,
            is_in_gray: 0,
          });
          return "0" !== "".concat(e.code)
      ...
      async function wn(e, t, a) {
        await a.setState({ listMode: e }),
          await a.dispatch(cn, t.subApp.name),
          nn.refreshTable();
      }
      ...
      async function kn(e) {
        ...
        await (async function (e, t) {
          ...
          return (
            (n = "".concat(n, "&nonce=").concat(r)),
            await nt.post(n, { versionId: t, appName: e })
          );
        })(t, a);
      }
      function Cn(e, t) {
          ...
          const { subAppName: a } = t,
            ...
            { list: l, count: o } = await (async function (e, t, a) {
              const n = t - 1,
                ...
                { list: l, count: o } = await nt.post(r, {
                  name: e,
                  page: n,
                  size: a,
                });
      ...
      const Kn = (e) => {
          ...
          const o = Object(f.a)(
            { display: "inline-block", width: r, height: n },
            l
          );
          return (
            "vertical" === a && (o.display = "block"),
            bt.a.createElement("div", { style: o }, t)
          );
        },
        Wn = (e) => bt.a.createElement(Kn, Object(f.a)({ width: "8px" }, e)),
        qn = (e) =>
          bt.a.createElement(Kn, Object(f.a)({ type: "vertical" }, e)),
        Jn = (e) => {
      ...
      function ar(e) {
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(
            "a",
            { target: "_blank", href: t, rel: "noopener noreferrer" },
            bt.a.createElement("b", null, n)
          )
        );
      }
      var nr, rr, lr, or, cr, ir, sr;
      Rn.b.languages.typescript.typescriptDefaults.setDiagnosticsOptions({
        ...
        const e = (e) => {
          ...
          t = bt.a.createElement(
            ...
            bt.a.createElement(
              ...
              {
                type: "primary",
                icon: bt.a.createElement(Fn.a, null),
                size: "large",
                onClick: () => e(T),
              },
              "\u521b\u5efa\u5e94\u7528"
            ...
            bt.a.createElement(
              Ba.a,
              {
                icon: bt.a.createElement(Hn.a, null),
                size: "large",
                onClick: () => e(M),
              },
              "\u63a2\u7d22\u66f4\u591a"
            ...
            bt.a.createElement(
              Ba.a,
              {
                icon: bt.a.createElement(Un.a, null),
                size: "large",
                onClick: () => window.open("https://tencent.github.io/hel"),
              },
              "hel-micro"
            ),
            bt.a.createElement(Er, null),
            bt.a.createElement(
              Ba.a,
              {
                ...
                size: "large",
                onClick: () =>
                  window.open("https://github.com/Tencent/hel/issues/112"),
              },
              "\u89c6\u9891\u6559\u5b66"
            )
          );
            ...
            bt.a.createElement(
              ...
              bt.a.createElement(
                ...
                bt.a.createElement(
                  "a",
                  {
                    href: "https://tencent.github.io/hel/",
                    target: "blank",
                    style: vr,
                  },
                  "hel-micro"
      ...
      function Kr(e) {
        ...
        return Fr.getShadowContainer
          ? Fr.getShadowContainer()
      ...
      var sl = bt.a.memo(function (e) {
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(
            Lr.a,
            { title: a },
            bt.a.createElement("span", { style: t }, a)
          ),
          e.showIcons
            && bt.a.createElement(
              Lr.a,
              { title: "\u8bbf\u95ee\u5f53\u524d\u5e94\u7528" },
              bt.a.createElement(tl.a, { style: ol })
            ),
        ...
        const t = Ct(pl[0], {}, e),
          ...
          l = {
            handleStarIconClick: (e) => {
              e.stopPropagation();
              const t = {
                appName: e.currentTarget.dataset.name,
                needDel: "starList" === r.module,
              };
            ...
            jumpTo: (e) => {
              ...
              t
                ? (t.startsWith("git@") && (t = t.replace("git@", "https://")),
                  window.top.open(t))
                : de.b.warn(
                    "\u5f53\u524d\u5b50\u5e94\u7528\u8fd8\u672a\u586b\u5199git\u4ed3\u5e93\u5730\u5740",
                    2
            ...
            getCardStyle() {
              ...
              return Object(f.a)(
                Object(f.a)({}, r),
                {},
                { backgroundColor: n ? "#f2f3f6" : "#d3e9f9" }
              );
            },
          };
        return l;
        ...
        const d = [
          bt.a.createElement(
            ...
            bt.a.createElement(
              "div",
              { onClick: fl },
              bt.a.createElement(Or.a, {
                size: 28,
                src: "".concat(Le(s.create_by)),
              })
            )
          ),
          bt.a.createElement(
            ...
            bt.a.createElement(
              "div",
              { "data-name": s.name, onClick: o.handleStarIconClick },
              m
            )
          ),
          bt.a.createElement(
        ...
        return (
          ...
          d.push(
            bt.a.createElement(
              ...
              bt.a.createElement(
                "div",
                { "data-name": s.name, onClick: Jr },
                bt.a.createElement(Tr.a, null)
              )
            ),
            bt.a.createElement(
              Lr.a,
              ...
              bt.a.createElement(
                "div",
                { "data-name": s.name, onClick: o.handleEditIconClick },
                bt.a.createElement(Vr.a, null)
              )
            )
          ),
          bt.a.createElement(
            ...
            bt.a.createElement(
              "div",
              { style: o.getStClassWrap(s.class_name || "") },
              s.class_name
            ),
            bt.a.createElement(
              "div",
              ...
              1 === s.is_top
                && bt.a.createElement(
                  Ir.a,
                  { className: "gHover", color: "#f50" },
                  bt.a.createElement(jr.a, null),
                  "\u8350"
                ),
              1 === s.is_test
                && bt.a.createElement(
                  Ir.a,
                  { className: "gHover", color: "grey" },
              ...
              bt.a.createElement(
                ...
                bt.a.createElement(
                  ...
                  bt.a.createElement(
                    rl,
                    null,
                    bt.a.createElement(Or.a, { src: s.logo })
                  ),
                  bt.a.createElement(sl, {
                    name: s.name,
                    data: s,
                    onTitleClick: o.onTitleClick,
                    showIcons: c,
                  }),
                  bt.a.createElement(
                    "div",
                    null,
                    bt.a.createElement(al, null, s.desc)
                  )
                )
              )
            )
      ...
      var Sl = bt.a.memo(() => {
        const { state: e, settings: t } = vt("starList", {
          setup: _l,
          ccClassKey: "StarList",
        });
        return bt.a.createElement(
      ...
      var Al = bt.a.memo(() => {
          const { state: e, settings: t } = vt("createdList", {
            setup: xl,
          ...
          n = a.computed({
            matchedUserOptions(e) {
              ...
              return Rl()
                ...
                : [
                    {
                      label: ft.createElement(
                        "div",
                        { style: { width: "100%", textAlign: "center" } },
                        ft.createElement(Nl.a, null)
                      ),
                    },
                  ];
            },
          ...
          async initStaffState() {
            Rl()
              || (await (async function () {
                ...
                const e = async (e, t) =>
                  nt.get(
                    "/api/user/getAllUsers?start=".concat(e, "&size=").concat(t)
                  );
                try {
                  let t = [];
                  const [a, n, r, l] = await Promise.all([
                    e(0, 5e4),
                    e(5e4, 5e4),
                    e(1e5, 5e4),
                    e(15e4, 5e4),
                  ...
                  return (
                    (t = t.concat(a).concat(n).concat(r).concat(l)),
                    (window.top._arrusers = t),
                    (zl = !0),
                    !0
                  );
                } catch (t) {
      ...
      function $l(e) {
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(Ml.a, {
            value: a.selectedClassInfo.class_key,
            disabled: !0,
          }),
      ...
      function Zl(e) {
        ...
        return bt.a.createElement(
          Oe.a,
          {
            visible: a.classTokenModalVisible,
            footer: [],
            onCancel: t.closeClassTokenModal,
            title: "\u67e5\u770b\u5206\u7c7btoken",
          },
          bt.a.createElement(
            jn.a,
      ...
      function ao(e) {
        ...
        const r = {
          ...
          showNewClassInfo: (e) => (
            e.preventDefault(), n.setState({ showNewClassInfo: !0 })
          ),
          gotoClassMgr() {
            _e(V);
          },
          async newClassInfo(e) {
            ...
            const o = await (async function (e, t) {
              ...
              return await nt.post(
                "/api/v1/classInfo/create?timestamp="
                  .concat(a, "&nonce=")
                  .concat(n),
                { key: e, name: t },
            ...
            "0" !== o.code
              ...
              : ((c = !0),
                de.b.success("\u65b0\u589e\u5206\u7c7b\u6210\u529f!"),
                ql.classInfoList.push(o.data)),
              n.setState(
                Object(f.a)({ newBtnLoading: !1, showNewClassInfo: !c }, Yl(t))
              );
          },
          openModal(e, t) {
            Jr(e),
              n.setState({
                modalVisible: !0,
                selectedClassInfo: t,
                editName: t.class_label,
              });
          },
          async openClassTokenModal(e, t) {
            Jr(e),
              n.setState({
                classTokenModalVisible: !0,
                selectedClassInfo: t,
                classToken: "",
                classTokenLoading: !0,
              });
            try {
              const e = await (async function (e) {
                ...
                return await nt.get(
                  "/api/v1/classInfo/getFull?timestamp="
                    .concat(t, "&nonce=")
                    .concat(a, "&id=")
                    .concat(e)
                );
          ...
          async modify() {
            ...
            const o = await (async function (e, t) {
              const { timestamp: a, nonce: n } = Ot();
              return await nt.post(
                "/api/v1/classInfo/update?timestamp="
                  .concat(a, "&nonce=")
                  .concat(n),
                { key: e, name: t },
                { returnLogicData: !1, check: !1 }
            ...
            "0" !== o.code
              ...
              : (de.b.success(
                ...
                (a.class_label = e)),
              n.setState(
                Object(f.a)({ updateBtnLoading: !1, modalVisible: !1 }, Yl(t))
              );
          },
        };
        return r;
      ...
      function no(e) {
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(
            ...
            bt.a.createElement(
              Ba.a,
              { onClick: t.cancelNewClassInfo },
              "\u53d6\u6d88"
            ),
            bt.a.createElement(Wn, { width: "20px" }),
            bt.a.createElement(
              Ba.a,
              { type: "primary", onClick: t.newClassInfo, loading: n },
              "\u786e\u8ba4"
            )
          )
        );
            ...
            a.user === t.create_by
              && bt.a.createElement(
                ...
                bt.a.createElement(
                  ...
                  bt.a.createElement(Gl.a, {
                    style: to,
                    onClick: (e) => a.openModal(e, t),
                  })
                ),
                ...
                n
                  && bt.a.createElement(
                    ...
                    bt.a.createElement(Kl.a, {
                      style: to,
                      onClick: (e) => a.openClassTokenModal(e, t),
                    })
                  )
              ),
            " )"
      ...
      function lo(e, t) {
        ...
        return a.visibleClassItems.map((a) => {
          ...
          return {
            ...
            classKey: r,
            label: t
              ? bt.a.createElement(ro, { settings: e, key: r, item: a })
              : n,
            value: r,
          };
        });
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(
            ...
            bt.a.createElement(
              ...
              {
                className: "gHover",
                onClick: e.showNewClassInfo,
                style: { color: "var(--lra-theme-color)" },
              },
              "\u65b0\u5efa"
            ),
            "\u4e00\u4e2a\uff09"
            ...
            dropdownRender: (e) =>
              a
                ? bt.a.createElement(
                    ...
                    l.state.showNewClassInfo
                      && bt.a.createElement(no, { settings: r })
                  )
                : bt.a.createElement(
                    bt.a.Fragment,
                    null,
      ...
      function uo(e) {
        ...
        t.effect(() => {
          t.mr.initPage(!0),
            localStorage.getItem(me.APP_CARD_GRAY)
              || (localStorage.setItem(me.APP_CARD_GRAY, 1),
              a.setState({ modelVisible: !0 }));
        }, []),
          t.watch("listMode", (e, a) => {
            e.listMode !== a.listMode && t.mr.fetchDataList({ page: 1 });
          });
        const n = () =>
            w(localStorage.getItem("HelHub.latestSearch"), []).filter(
              (e) => !!e
            ),
          r = {
            ins: a,
            ...
            searchAppByClassKey(e) {
              t.mr.setState({ classKey: void 0 === e ? "-10000" : e }),
                t.mr.searchApp();
            },
            renderLatestSearchMenu() {
              ...
              return bt.a.createElement(
                Ll.a,
                {
                  className: "smallScBar",
                  onClick: r.handleNameClick,
                  style: {
                    maxHeight: "380px",
                    overflowY: "scroll",
                    width: "280px",
      ...
      var mo = bt.a.memo(() => {
        const {
            ...
            syncer: a,
            mr: n,
          } = vt("appStore", { setup: uo, ccClassKey: "AppStore" }),
          { ins: r } = t,
        ...
        return bt.a.createElement(
          ...
          "test" === e.listMode
            && bt.a.createElement("img", {
              src: "http://mat1.gtimg.com/news/js/tnfe/imgs/leah4/test_app.png",
              style: io,
            }),
          bt.a.createElement(
            xr.a,
              ...
              bt.a.createElement(
                ...
                ["name", "name_exact"].includes(e.searchType)
                  && bt.a.createElement(
                    ...
                    bt.a.createElement(Ba.a, {
                      style: so,
                      className: "gHover",
                      icon: bt.a.createElement(Vl.a, null),
                    })
                  )
              ),
              bt.a.createElement(Wn, null),
              bt.a.createElement(co, {
                allowEdit: !1,
                style: { width: "220px", verticalAlign: "top" },
                onChange: t.searchAppByClassKey,
              }),
              bt.a.createElement(Wn, null),
              bt.a.createElement(
                Ba.a,
                {
                  onClick: n.refreshCurPage,
                  className: "gHover",
          ...
          bt.a.createElement(
            ...
            bt.a.createElement(
              xr.a,
              { justify: "center" },
              0 === e.subApps.length && bt.a.createElement(Sr.a, null)
            ),
            bt.a.createElement(
              xr.a,
              { gutter: [16, 16] },
              ...
              footer: [
                bt.a.createElement(
                  Ba.a,
                  {
                    key: "1",
                    type: "primary",
                    onClick: () => r.setState({ modelVisible: !1 }),
                  },
                  "Ok"
                ),
              ],
      ...
      var ho = bt.a.memo(() => {
          const { state: e } = Object(h.useConcent)(
            { module: "top", setup: go },
            "Top"
          );
          return bt.a.createElement(
      ...
      function Eo(e) {
        let { width: t = "20px" } = e;
        return bt.a.createElement("div", {
          style: { width: t, display: "inline-block" },
        });
      }
      var yo = a(775),
        wo = a(781);
        ...
        return e.map((e, a) => {
          ...
          if ("select" === n) {
            ...
            i = bt.a.createElement(
              ...
              t.map((e, t) =>
                bt.a.createElement(Io, { key: t, value: e.value }, e.label)
              )
            );
          } else if ("input" === n)
            i = bt.a.createElement(
              Ml.a,
              Object.assign({ style: l }, c, { placeholder: o })
            );
          else if ("inputNumber" === n) i = bt.a.createElement(yo.a, c);
          else {
            if ("customize" !== n)
              throw new Error("not implemented type[".concat(n, "]"));
            i = e.render(r, t);
          }
          const p = t ? [t, r] : r;
          return bt.a.createElement(
            bo.a.Item,
            { key: a, name: p, noStyle: !0, rules: s },
            i
          );
        });
      }
      function jo(e) {
        ...
        return (
          ...
          bt.a.createElement(
            bo.a.Item,
            { key: Mo(), label: a, name: t, style: { marginBottom: "10px" } },
            s
          )
        );
      }
      function No(e) {
        ...
        return (
          (p = l
            ? l({ initValue: s, options: i })
            : bt.a.createElement(
                Bn.a.Group,
                Object.assign({ options: r, value: s }, c)
              )),
          bt.a.createElement(
            bo.a.Item,
            {
      ...
      function Do(e) {
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(
            Ml.a,
            Object.assign({ placeholder: n, value: r }, o)
          )
        );
      }
      function Bo(e) {
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(
            Il.a,
            Object.assign({ placeholder: r, value: l }, c, {
              getPopupContainer: Kr,
            }),
            n.map((e, t) =>
              bt.a.createElement(Io, { key: t, value: e.value }, e.label)
      ...
      function zo(e) {
        ...
        return bt.a.createElement(
          bo.a.Item,
          { key: Mo(), label: t, style: { marginBottom: "10px" } },
          n
        );
      }
      function Ro(e) {
      ...
      function Ho(e) {
        ...
        return bt.a.createElement(
          bo.a.Item,
          { key: Mo(), name: n, label: r, style: { marginBottom: "10px" } },
          l
        );
      }
      const Uo = {
      ...
      const { Item: Ko } = bo.a,
        ...
        $o = (e) => {
          e.initState({
            formLayout: e.props.layout || "horizontal",
            loading: !1,
          }),
            e.computed(Yo),
          ...
          e.props.dynamicLayout
            && (a = () =>
              bt.a.createElement(
                Ko,
                {
                  label: e.props.layoutFieldLabel || "Form Layout",
                  style: { marginBottom: "10px" },
                },
                bt.a.createElement(
                  Wo,
          ...
          return {
            ...
            onFinish: (t) => {
              e.props.onFinish
                && (e.props.onFinish(t), e.setState({ loading: !0 }));
            },
          };
        };
      var Xo = bt.a.memo((e) => {
        const [t] = bo.a.useForm(),
          ...
          g = { layout: n };
        e.fields.forEach((e) => {
          Object.prototype.hasOwnProperty.call(e.options, "value")
            && (g[e.options.name] = e.options.value);
        });
            ...
            bt.a.createElement(
              ...
              f
                && bt.a.createElement(
                  ...
                  bt.a.createElement(
                    Ba.a,
                    { type: "primary", htmlType: "submit", loading: r },
                    e.submitBtnLabel || "Submit"
                  ),
                  s
                    ? bt.a.createElement(
                        bt.a.Fragment,
                        null,
                        bt.a.createElement(Eo, null),
                        s
                      )
                    : "",
                  p
      ...
      const sc = {
          ...
          options: {
            ...
            label: bt.a.createElement(
              ...
              bt.a.createElement(
                Lr.a,
                { title: ec, color: "blue", getPopupContainer: Kr },
        ...
        pc = {
          ...
          options: {
            ...
            label: bt.a.createElement(
              ...
              bt.a.createElement(
                Lr.a,
                { title: tc, color: "blue", getTooltipContainer: Kr },
                bt.a.createElement(fo.a, null)
              ),
              bt.a.createElement(Wn, null),
              bt.a.createElement(
          ...
          options: {
            ...
            label: bt.a.createElement(
              ...
              bt.a.createElement(
                Lr.a,
                { title: Qo, color: "blue" },
                bt.a.createElement(fo.a, { getTooltipContainer: Kr })
              ),
              bt.a.createElement(Wn, null),
              bt.a.createElement(
                Ir.a,
        ...
        yc = {
          ...
          options: {
            ...
            label: bt.a.createElement(
              ...
              bt.a.createElement(
                Lr.a,
                { title: ac, color: "blue", getTooltipContainer: Kr },
                bt.a.createElement(fo.a, null)
              )
            ),
          },
        ...
        wc = {
          ...
          options: {
            ...
            label: bt.a.createElement(
              ...
              bt.a.createElement(
                Lr.a,
                { title: nc, color: "blue", getTooltipContainer: Kr },
                bt.a.createElement(fo.a, null)
              ),
              bt.a.createElement(Wn, null),
      ...
      function Lc(e) {
        ...
        let a = t;
        return (
          v(e) || ((a = {}), Object.keys(t).forEach((t) => (a[t] = e[t]))),
          (a.token = ic()),
          a
        );
      }
      const Ic = (e) => {
        const t = Ct(h.cst.MODULE_DEFAULT, {}, e),
          ...
          i = l || "prod";
        "prod" === i
          ? ((c.app_group_name = c.name), (c.is_test = 0))
          : (c.is_test = 1);
        const s = a({
            defaultValues: c,
            toCommitValues: {},
        ...
        const d = {
          ...
          onValuesChange: (e, t) => {
            ...
            k(e, "name") && "prod" === p.formCreateMode
              ? (t.setFieldsValue({ app_group_name: e.name }),
                Object.assign(n, a, { app_group_name: e.name }))
              : Object.assign(n, a),
              k(e, "name")
                && m
                && ((m = !1), t.setFieldsValue({ token: ic() })),
          ...
          onFormFinish: async (e) => {
            ...
            if (
              (S(a, "owners"),
              S(a, "gray_users"),
              a.enable_gray && 0 === a.gray_users.length)
            )
              return t(
                "\u5f53\u524d\u5e94\u7528\u5f00\u542f\u4e86\u7070\u5ea6\u529f\u80fd\uff0c\u8bf7\u8bbe\u7f6e\u7070\u5ea6\u7528\u6237\u540d\u5355"
              );
            if (a.owners.length > 50)
              return t("\u8d1f\u8d23\u4eba\u4e0d\u80fd\u5927\u4e8e 50");
            if (a.gray_users.length > 50)
              return t("\u7070\u5ea6\u540d\u5355\u4e0d\u80fd\u5927\u4e8e 50");
          ...
          selAct(e) {
            ...
            (a.name = "hlib-yourRtx"),
              ...
              (a.cnname = "hel\u51fd\u6570\u6a21\u5757"),
              (a.git_repo_url =
                "https://github.com/hel-eco/hel-activity/my-first-hel-lib"),
              (a.enable_gray = 0),
              (a.ui_framework = "lib"),
              (a.desc =
                "\u8fd9\u662f\u6211\u7684\u7b2c\u4e00\u4e2ahel\u51fd\u6570\u6a21\u5757\uff0c\u4ed6\u5c06\u88ab\u591a\u4e2a\u9879\u76ee\u8fdc\u7a0b\u52a8\u6001\u52a0\u8f7d"),
              de.b.info(
                "\u6b22\u8fce\u2501(*\uff40\u2200\xb4*)\u30ce \u53c2\u52a0\u521b\u5efahel\u51fd\u6570\u6a21\u5757\u6d3b\u52a8"
              ),
          ...
          async createApp() {
            ...
            const { toCommitValues: t, formCreateMode: a } = s.state,
              n = E(t);
            n.ui_framework || (n.ui_framework = "lib"),
              n.class_key || (n.class_key = ""),
              (n.cnname = n.cnname || n.name);
            try {
          ...
          getModalFooter: () =>
            "prod" === p.formCreateMode
              ? [
                  bt.a.createElement(
                    Ba.a,
                    { key: "1", onClick: d.closeConfirmModal },
                    "\u53d6\u6d88"
                  ),
                  bt.a.createElement(
                    Ba.a,
      ...
      var Oc = bt.a.memo((e) => {
          const { settings: t } = vt(h.cst.MODULE_DEFAULT, {
              setup: Ic,
              props: e,
            }),
            { insState: a } = t;
          return bt.a.createElement(
            ...
            bt.a.createElement(
              ...
              {
                title: t.getUiTitle(),
                style: { width: "1110px", margin: "0 auto", textAlign: "left" },
              },
            ...
            bt.a.createElement(
              Oe.a,
              {
                ...
                onCancel: t.closeConfirmModal,
                visible: a.confirmCreateModalVisible,
                footer: t.getModalFooter(),
              },
              t.getModalContent()
            )
          );
        ...
        Mc = bt.a.memo(() =>
          bt.a.createElement(Oc, { mode: "prod", hasAct: !0 })
        );
      const Tc = { color: "red" };
      function Vc() {
        return bt.a.createElement(
              ...
              return "corsProxy" !== e || r.startsWith('{"code":0,"data":[{')
                ? "wsdUsers" !== e || r.startsWith("var _arrusers = [[")
                  ? (await (async function (e, t) {
                      ...
                      return await nt.post(
                        "/api/helper/syncStaff?timestamp="
                          .concat(a, "&nonce=")
                          .concat(n),
                        { staffStr: e, syncType: t }
                      );
                    })(r, e),
      ...
      var Dc = bt.a.memo(() => {
        const { settings: e } = Object(h.useConcent)(
            { setup: Nc },
            "SyncStaff"
          ),
          { inputRef: t, ins: a } = e;
        return xt("portal").isAdmin
          ? bt.a.createElement(
              "div",
              { style: { textAlign: "center" } },
              bt.a.createElement(Ml.a.TextArea, {
                rows: 25,
                ref: t,
              ...
              bt.a.createElement(
                ...
                bt.a.createElement(
                  ...
                  {
                    title:
                      "\u6570\u636e\u6765\u81ea http://xxx-cors/api/v1/getStaff",
                  },
                  bt.a.createElement(
                    Bn.a,
                    { value: "corsProxy" },
                ...
                bt.a.createElement(
                  ...
                  {
                    title:
                      "\u6570\u636e\u6765\u81ea http://xxx-wsd-users/js/users.js",
                  },
                  bt.a.createElement(
                    Bn.a,
                    { value: "wsdUsers" },
            ...
            try {
              ...
              const e = await (async function () {
                const e = St("portal").userInfo.user,
                  t = Date.now();
                let a = "/api/v1/allowed-app/getList?user="
                  .concat(e, "&timestamp=")
                  .concat(t);
        ...
        return {
          ...
          async submit() {
            try {
              ...
              const e = await (async function () {
                const e = St("portal").userInfo.user,
                  t = Date.now();
                let a = "/api/v1/allowed-app/refresh?user="
                  .concat(e, "&timestamp=")
                  .concat(t);
                return (a = lt(a, e, t)), await nt.get(a);
              })();
          ...
          copy() {
            de.b.success(
              ...
              el()(t.state.list.join(","));
          },
          copyJson() {
            de.b.success(
              "\u590d\u5236\u5e94\u7528\u767d\u540d\u5355Json\u6210\u529f\uff01"
            ),
              el()(JSON.stringify(t.state.list));
          },
        };
      }
      var Rc = bt.a.memo(() => {
      ...
      const Zc = $a.c.div(
        ...
        ni = $a.c.button(
          ...
          (e) =>
            Object($a.b)(
              Yc || (Yc = Object(Ya.a)(["border:1px solid ", ""])),
              e.primary ? "#007acd" : "lightgrey"
            ),
          (e) =>
            Object($a.b)(
              $c || ($c = Object(Ya.a)(["background-color:", ""])),
              e.primary ? "#007acd" : "white"
            ),
          (e) =>
            Object($a.b)(
              Xc || (Xc = Object(Ya.a)(["color:", ""])),
              e.primary ? "white" : "black"
            )
        );
      function ri(e) {
        ...
        return (
          ...
          e.on("closeModal", (t) => {
            ...
            (a = { onOk: l, onCancel: o }),
              e.setState({ show: !0, title: n, content: r });
          }),
          {
            closeModal: t,
            handleOk: () => {
          ...
          ? bt.a.createElement(
              ...
              bt.a.createElement(
                ...
                bt.a.createElement(
                  ...
                  bt.a.createElement(
                    ni,
                    { className: "gHover", onClick: t.closeModal },
                    "\u53d6\u6d88"
                  ),
                  bt.a.createElement(
                    ni,
                    { primary: !0, className: "gHover", onClick: t.handleOk },
                    "\u786e\u8ba4"
                  )
                )
              )
      ...
      class oi extends bt.a.Component {
        ...
        render() {
          return this.mountNode
            ? Tn.a.createPortal(bt.a.createElement(li, null), this.mountNode)
        ...
        return {
          tryGetToken: () => {
            t.emit("tryGetToken", async (e) => {
              de.b.info(
                "\u5e94\u7528 [".concat(e, "] token \u83b7\u53d6\u4e2d..."),
                1
              );
              try {
                const a = await (async function (e) {
                  const t = await nt.get(
                    "/api/v1/app/info/getSubAppToken?name=".concat(e),
                    "",
                    { check: !1, returnLogicData: !1 }
                  );
      ...
      var di = bt.a.memo(function (e) {
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(
            Ba.a,
            { size: "small", type: "primary", onClick: t.tryGetToken },
            "\u67e5\u770btoken"
          )
        );
      });
            ...
            async submit() {
              ...
              try {
                "user" === n
                  ? (await (async function (e) {
                      return await nt.post(
                        "/api/v1/app/info/updateAppUserMarkInfo",
                        e
                      );
                    })({ name: l, ver: o, desc: t }),
                    await Lt.portal.initUserExtendData())
                  : (await (async function (e) {
                      const t = ot(
                        "/api/v1/app/info/updateAppGlobalMarkInfo",
                        e.name
                      );
                      return await nt.post(t, e);
                    })({ name: l, ver: o, desc: t }),
      ...
      function vi(e) {
        ...
        t.on("openMetaDataDrawer", async (e) => {
          ...
          const o = await (async function (e, t) {
            return await nt.get(
              "/openapi/v1/app/info/getSubAppAndItsFullVersion?name="
                .concat(e, "&version=")
                .concat(t)
            );
          })(r, l);
        ...
        const n = {
          ...
          copyUrl() {
            de.b.success("\u590d\u5236\u63a5\u53e3\u6210\u529f"),
              el()(n.getInterfaceUrl());
          },
          copyUrlNoHC() {
            de.b.success(
              "\u590d\u5236\u63a5\u53e3\uff08\u65e0html_content\uff09\u6210\u529f"
            ),
              el()(n.getInterfaceUrlNoHC());
          },
          copyOutUrl() {
            de.b.success("\u590d\u5236\u5916\u7f51\u63a5\u53e3\u6210\u529f"),
              el()(n.getInterfaceUrl(!0));
          },
          copyOutUrlNoHC() {
            de.b.success(
              "\u590d\u5236\u5916\u7f51\u63a5\u53e3\uff08\u65e0html_content\uff09\u6210\u529f"
            ),
              el()(n.getInterfaceUrlNoHC(!0));
          },
        };
        return n;
      }
      var ki = bt.a.memo(function () {
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(
            "a",
            { href: e.getInterfaceUrl(), target: "_blink" },
            "\u63a5\u53e3"
          ),
          ...
          bt.a.createElement(
            "a",
            { href: e.getInterfaceUrlNoHC(), target: "_blink" },
            "\u63a5\u53e3(\u65e0html_content)"
          ),
          ...
          bt.a.createElement(
            "a",
            { href: e.getInterfaceUrlNoHC(!0), target: "_blink" },
            "\u5916\u7f51\u63a5\u53e3"
          ),
          ...
          }),
          {
            ...
            async submit() {
              ...
              if (e && t) {
                a.setState({ loading: !0 });
                try {
                  await Lt.VersionList.resetVerCache({
                    verAppName: t,
                    verID: e,
                  }),
                    de.b.success(
              ...
              description: bt.a.createElement(
                ...
                bt.a.createElement(
                  Ir.a,
                  {
                    color: t,
                    className: "gHover",
                    onClick: () => Lt.VersionList.changeListMode(e),
                  },
                  a
                ),
                "\u5207\u6362\u5217\u8868\u4e3a",
      ...
      function Zi(e, t) {
        ...
        const s = { border: "1px solid lightgrey", backgroundColor: "" },
          ...
          d = o.find((e) => e.ver === c);
        u
          ? ((s.border = "1px solid ".concat(Fi)),
            (s.backgroundColor = Bi),
            (i = Ki))
          : p
          ? ((s.border = "1px solid ".concat(Hi)),
            (s.backgroundColor = Pi),
            (i = Wi))
          : m
          ? ((s.border = "1px solid ".concat(Ui)),
            (s.backgroundColor = zi),
            (i = qi))
          : d
            && ((s.border = "1px solid ".concat(Gi)),
            (s.backgroundColor = Ri),
            (i = Ji));
        let g = "",
          h = "",
          b = "",
          ...
          e
            && (w = bt.a.createElement(
              ...
              bt.a.createElement(
                ...
                { style: v },
                " (",
                Pr(new Date(t).toLocaleString()),
                ")"
              )
            ));
        }
        return {
          uiConner: bt.a.createElement(
            "div",
      ...
      function Qi(e, t) {
        ...
        O = n.subApp.is_local_render
          ? ""
              .concat(window.top.location.origin, "/page/")
              .concat(e.sub_app_name, "?ver=")
              .concat(f)
          : "".concat(n.subApp.render_app_host, "?_appv=").concat(f) || "";
        const M = async (e) => {
            t(!0);
            const a = await Lt.VersionList.updateAppVersion({
              inputVersion: f,
              changeMode: e,
            });
            if ((t(!1), a && a.subApp)) {
        ...
        if ("hasTitle" === a)
          ...
          const t = (t) =>
              Xi(t) && Object(h.emit)("selectAsProjVer", e, "online"),
                  ...
                  bt.a.createElement(
                    ...
                    bt.a.createElement(
                      Ba.a,
                      {
                        style: Yi,
                        onClick: (t) =>
                          Xi(t) && Object(h.emit)("openMetaDataDrawer", e),
                      },
                      "\u5143\u6570\u636e"
                    )
                  ),
                  ...
                  bt.a.createElement(
                    ...
                    bt.a.createElement(
                      Ba.a,
                      {
                        ...
                        onClick: (t) =>
                          Xi(t)
                          && Object(h.emit)("openMarkInfoModal", e, "user"),
                      },
                      "\u4e2a\u4eba\u6807\u8bb0"
                    )
                  ),
                  ...
                  bt.a.createElement(
                    ...
                    bt.a.createElement(
                      Ba.a,
                      {
                        ...
                        onClick: (t) =>
                          Xi(t)
                          && Object(h.emit)("openMarkInfoModal", e, "global"),
                      },
                      "\u5168\u5c40\u6807\u8bb0"
                    )
                  ),
                  bt.a.createElement(
                    ...
                    bt.a.createElement(
                      Ba.a,
                      {
                        ...
                        disabled: v,
                        onClick: (t) =>
                          Xi(t) && Object(h.emit)("openResetVerModal", e),
                      },
                      "\u5237\u65b0\u7f13\u5b58"
                    )
                  ),
          ...
          t = bt.a.createElement(
            ...
            bt.a.createElement(
              "a",
              {
                ...
                target: "_blank",
                rel: "noopener noreferrer",
                href: "".concat(n, "/commit/").concat(r[0]),
                onClick: Xi,
              },
              r[0]
            ),
            bt.a.createElement(
              ...
              bt.a.createElement(
                Ir.a,
                { color: "#87d068", onClick: a, className: "gHover" },
                l
              )
            ),
            bt.a.createElement(
              ...
              {
                title:
                  "\u70b9\u51fb\u590d\u5236\u57fa\u4e8e\u6b64hash\u5206\u652f\u68c0\u51fa\u65b0\u5206\u652f\u7684git\u547d\u4ee4",
              },
              bt.a.createElement(
                Ir.a,
                { onClick: c, className: "gHover" },
                " ",
                bt.a.createElement(ji.a, null)
              )
            )
          );
        }
        ...
        return bt.a.createElement(zn.a, {
          ...
          description: bt.a.createElement(
            ...
            bt.a.createElement(
              ...
              {
                target: "blank",
                href: "https://www.bilibili.com/video/BV15t4y1u7i5",
              },
              "\u89c6\u9891"
            ),
            "\u4e0e",
            bt.a.createElement(
              ...
              {
                target: "blank",
                href: "https://tencent.github.io/hel/docs/tutorial/helmod-dev",
              },
              "\u6587\u6863"
            ),
            bt.a.createElement("br", null),
            ...
            bt.a.createElement(
              ...
              {
                target: "blank",
                href: "https://juejin.cn/post/7139379656825765918",
              },
              "\u6a21\u5757\u8054\u90a6\u65b0\u9769\u547d"
            )
          ),
      ...
      const rs = { color: "rgba(0,0,0,.7)", verticalAlign: "top" },
        ...
        is = bt.a.memo(() => {
          const {
              ...
              sync: a,
              mr: n,
            } = vt("VersionList", { tag: "VTableTitle" }),
            r =
              "gray" === e.changeMode
                ? "\u8bf7\u8f93\u5165\u6b32\u4fee\u6539\u7684\u7070\u5ea6\u7248\u672c"
                : "\u8bf7\u8f93\u5165\u6b32\u4fee\u6539\u7684\u7ebf\u4e0a\u7248\u672c",
          ...
          1 === e.subApp.enable_gray
            && (s = bt.a.createElement(
              ...
              bt.a.createElement(
                Ba.a,
                { onClick: n.showChangeGrayInput, danger: !0 },
                "\u5207\u6362\u7070\u5ea6\u7248\u672c"
              ),
              bt.a.createElement(Wn, null)
            ));
          ...
          e.subApp.is_in_gray
            && (p = bt.a.createElement(
              ...
              bt.a.createElement(
                Ba.a,
                {
                  loading: e.grayBtnLoading,
                  type: "primary",
                  onClick: n.clickAgreeGrayBtn,
                },
                "\u7070\u5ea6\u901a\u8fc7"
              ),
              bt.a.createElement(Wn, null)
          ...
          return bt.a.createElement(
            ...
            bt.a.createElement(
              ...
              null,
              "\u7ebf\u4e0a\u7248\u672c\uff1a",
              bt.a.createElement(cs, null, e.subApp.online_version)
            ),
            ...
            bt.a.createElement(
              ...
              bt.a.createElement(
                ...
                bt.a.createElement(
                  Ba.a,
                  { onClick: n.showChangeOnlineInput, danger: !0 },
                  "\u5207\u6362\u5728\u7ebf\u7248\u672c"
                )
              ),
              bt.a.createElement(Wn, null),
              bt.a.createElement(
                Ba.a,
                { onClick: n.freshSubAppAssociateAndTable },
                "\u5237\u65b0"
              )
            ),
            e.showInput
              ? bt.a.createElement(
                  ...
                  bt.a.createElement(
                    ...
                    bt.a.createElement(
                      Ba.a,
                      {
                        loading: e.updateLoading,
                        type: "primary",
                        onClick: n.clickUpdateVersionBtn,
                      },
                      "\u786e\u8ba4"
                    ),
                    bt.a.createElement(Wn, null),
        ...
        ss = function (e, t) {
          ...
          if ("switchAllTip" === i || "switchMarkTip" === i)
            return 0 === o ? ns() : "switchAllTip" === i ? as(a) : ts(a);
          const {
              uiConner: s,
              stCard: p,
              CardComp: u,
                ...
                bt.a.createElement(
                  ...
                  bt.a.createElement(
                    "a",
                    {
                      target: "_blank",
                      rel: "noopener noreferrer",
                      href: "".concat(h, "/tree/").concat(e.git_branch),
                      onClick: Xi,
                    },
        ...
        ps = (e) => [
          {
            key: "op",
            title: () => bt.a.createElement(is, null),
            render: (t, a) => ss(a, e),
          },
        ],
        us = (e) => [
              ...
              ((e) => {
                ...
                return bt.a.createElement(
                  ...
                  bt.a.createElement(
                    ...
                    bt.a.createElement(ws, {
                      title: "\u5bb9\u5668\u540d\u79f0",
                      label: e.container_name,
                    }),
                    bt.a.createElement(ws, {
                      title: "\u5bb9\u5668ip",
                      label: e.container_ip,
                    }),
                    bt.a.createElement(ws, {
                      title: "pod\u540d\u79f0",
                      label: e.pod_name,
      ...
      function _s(e) {
        ...
        return (
          t.setState({ subAppName: t.props.name }),
          { fetchFn: t.mr.fetchDataList, pageSizeOptions: ["10", "20", "30"] }
        );
      }
      function Ss(e) {
        const { settings: t, state: a } = vt("ServerModList", {
            setup: _s,
            props: e,
            tag: "ServerModList",
          }),
            ...
            try {
              ...
              const e = n(),
                t = await (async function (e) {
                  const t = Date.now();
                  let a = "/api/v1/allowed-app/isAllowed?name="
                    .concat(e, "&timestamp=")
                    .concat(t);
                  return (a = lt(a, e, t)), await nt.get(a);
                })(e);
              ...
              de.b.error(e.message),
                a.setState({ pAllowOutAccessBtnLoading: !1 });
            }
          };
        t.effect(() => {
          r();
          ...
          async changeAllowed() {
            try {
              ...
              de.b.error(e.message),
                ...
                a.setState({
                  pAllowOutAccessBtnLoading: !1,
                  isAllowed: a.state.isAllowedOri,
                });
            }
          },
          onAllowedChanged(e) {
          ...
          bt.a.createElement(
            ...
            bt.a.createElement(
              Ba.a,
              {
                type: "primary",
                disabled: !t.canEdit(),
                onClick: t.resetAppInfo,
                loading: a.pResetAppInfoBtnLoading,
              },
              "\u5237\u65b0\u5e94\u7528\u7f13\u5b58"
            ),
            bt.a.createElement(qn, { height: "8px" }),
              ...
              bt.a.createElement(
                ...
                bt.a.createElement(
                  Ba.a,
                  {
                    type: "primary",
                    disabled: !t.canEdit(),
                    onClick: t.changeAllowed,
                    loading: a.pAllowOutAccessBtnLoading,
                  },
                  "\u786e\u8ba4\u4fee\u6539"
                )
              )
      ...
      function Ns(e) {
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(gs, {
            subApp: a.state.subApp,
            titleUiMode: "noTitle",
          })
        );
      }
      ...
      function Rs(e) {
        ...
        return bt.a.createElement(
            ...
            Mr.a,
            {
              content: bt.a.createElement(
                ...
                bt.a.createElement(
                  ...
                  bt.a.createElement(
                    Ba.a,
                    { onClick: () => e.copyToRow(t, e.uiId) },
                    "\u6a2a\u5411\u590d\u5236"
                  ),
                  bt.a.createElement(Jn, null),
                  bt.a.createElement(
                    Ba.a,
                    { onClick: () => e.copyToCol(t, e.verKey) },
                    "\u7eb5\u5411\u590d\u5236"
                  ),
                  bt.a.createElement(Jn, null),
                  bt.a.createElement(
                    Ba.a,
                    { onClick: () => e.copyToAll(t) },
                    "\u5168\u65b9\u5411\u590d\u5236"
                  )
                )
              ),
          ...
          bt.a.createElement(
            ...
            bt.a.createElement(Mi.a, {
              onClick: () => e.delCellVer(e.uiId, e.verKey),
              style: { color: "grey" },
            })
          )
        );
      ...
      function Fs(e) {
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(
            ...
            bt.a.createElement(
              Ba.a,
              { onClick: e.addItem, type: "link", style: { padding: "2px" } },
              "\u589e\u52a0"
            ),
            bt.a.createElement(Jn, null),
            bt.a.createElement(
      ...
      function Hs(e) {
          ...
          t.on("selectAsProjVer", (e, a) => {
            ...
            if (s) {
              if ("online" === a) s.onlineVerId = i;
                ...
                if ("ol_bu" !== a)
                  return void alert("unknown selType ".concat(a));
        ...
        return {
          ...
          selectVersion(e) {
            l.setState({ idx: e }),
              t.emit("openSelectVersionLayer", t.state.subApp);
          },
          delItem(e) {
          ...
          async refresh() {
            t.setState({ projVerAreaLoading: !0 }),
              await t.mr.freshSubAppAssociate();
            const e = r(t.state.subApp),
              l = n();
            await t.setState(
              Object(f.a)(
                Object(f.a)({}, l),
                {},
                { projVerAreaLoading: !1, mapBackup: e, pLineDataList: a(e) }
              )
            );
          },
        };
      ...
      function Us(e) {
        const { settings: t, state: a } = vt("VersionList", {
            setup: Hs,
            props: e,
            tag: "ProjVerMap",
          }),
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(
            ...
            bt.a.createElement(
              ...
              bt.a.createElement(
                Ir.a,
                { color: "blue", style: { verticalAlign: "bottom" } },
                "\u5fc5\u987b"
              )
            ),
            bt.a.createElement(
          ...
          bt.a.createElement(
            ...
            bt.a.createElement(
              ...
              r.map((e, a) =>
                bt.a.createElement(Fs, {
                  ...
                  buildVerIdSyncer: n.sync(
                    "pLineDataList.".concat(a, ".buildVerId")
                  ),
                  onlineVerIdSyncer: n.sync(
                    "pLineDataList.".concat(a, ".onlineVerId")
                  ),
            ...
            bt.a.createElement(
              ...
              bt.a.createElement(
                Ba.a,
                { onClick: () => t.addItem(r.length) },
                bt.a.createElement(Fn.a, null),
                "\u65b0\u589e"
              ),
              bt.a.createElement(Jn, null),
              bt.a.createElement(
      ...
      function Ys(e) {
        ...
        const r = {
          onClose: () => {
            a.setState({ visible: !1, selTab: "application" }),
              Lt.VersionList.clear();
          },
          onFormFinish: (e) => {
            ...
            if (
              ...
              return (
                t.emit("cancelFormBtnLoading"),
                de.b.warn("\u8d1f\u8d23\u4eba\u4e0d\u80fd\u5927\u4e8e 50")
              );
            if (r.gray_users.length > 50)
              return (
                t.emit("cancelFormBtnLoading"),
                de.b.warn("\u7070\u5ea6\u540d\u5355\u4e0d\u80fd\u5927\u4e8e 50")
              );
              ...
              Lt.appStore
                ...
                .then((e) => {
                  e
                    && (de.b.info("\u66f4\u65b0\u6210\u529f"),
                    a.setState({
                      subApp: Object(f.a)(Object(f.a)({}, n.subApp), r),
                    }));
                })
          ...
          switchTab: (e) => {
            ...
            a.setState({ selTab: e }),
              n
                ? "visit" === e
                  && t.emit("openConfirmVisitAppModal", n, a.state.subApp)
                : de.b.warn("\u7f3a\u5931 appName \u53c2\u6570");
          },
          state: n,
        };
        return r;
          ...
          getTitle: () =>
            "prod" === n.mode
              ...
              : bt.a.createElement(
                  ...
                  bt.a.createElement(
                    Ir.a,
                    { color: "var(--lra-theme-color)" },
                    n.subApp.app_group_name
                  ),
                  "\u7684\u65b0\u5e94\u7528"
                ),
        };
      ...
      var Zs = bt.a.memo(function () {
          ...
          return bt.a.createElement(
            ...
            bt.a.createElement(Oc, {
              key: "".concat(t.name, "_").concat(a),
              subApp: t,
              mode: a,
            })
          );
      ...
      const {
        ...
        vp = {
          [pp]: {
            label: "\u6211\u7684\u521b\u5efa",
            icon: bt.a.createElement(Qs.a, null),
          },
          [ip]: {
            label: "\u6700\u8fd1\u8bbf\u95ee",
            icon: bt.a.createElement(ep.a, null),
          },
          [hp]: {
            label: "\u540c\u6b65\u5458\u5de5",
            icon: bt.a.createElement(ep.a, null),
      ...
      function kp(e) {
        let t = "",
          ...
          n = "";
        return (
          vp[e] ? ((a = "uCenter"), (n = e)) : ((t = e), (n = pp)),
          { radioBtnKey: t, dropBtnKey: a, subMenuKey: n }
        );
      }
      ...
      function _p(e) {
        return bt.a.createElement(
          "div",
          { className: "gHoverTransToBlue", style: Cp, onClick: e.onClick },
          e.children
        );
      }
      function Sp(e) {
        const t = e.initState(
          (function () {
            let e = ke();
            return (
              "/" === e ? (e = ip) : Ep.includes(e) || (e = ""),
              Object(f.a)({ open: !1, path: e }, kp(e))
            );
          })()
        );
        ...
        const a = {
          ...
          handleDropBtnClick: () => {
            ...
            _e(a),
              e.setState({ dropBtnKey: "uCenter", path: a, radioBtnKey: "" });
          },
          clickSubMenu(t) {
            const a = t.key;
            _e(a),
      ...
      var xp = bt.a.memo(() => {
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(
            ...
            bt.a.createElement(
              wp,
              { value: up, style: { width: "110px" } },
              bt.a.createElement(ap.a, null),
              " \u5e94\u7528\u5546\u5e97"
            ),
            bt.a.createElement(
              wp,
              { value: dp, style: { width: "110px" } },
              bt.a.createElement(np.a, null),
              " \u65b0\u5efa\u5e94\u7528"
            ),
            bt.a.createElement(
              wp,
              { value: gp, style: { width: "110px" } },
              bt.a.createElement(rp.a, null),
              " \u7f6e\u9876\u63a8\u8350"
            ),
            bt.a.createElement(
              wp,
              { value: mp, style: { width: "110px" } },
              bt.a.createElement(lp.a, null),
              " \u5173\u4e8e\u6d77\u62c9"
            ),
            bt.a.createElement(
              wp,
              { value: bp, style: { width: "110px" } },
              bt.a.createElement(ii.a, null),
              " \u6211\u7684\u5206\u7c7b"
            ),
            bt.a.createElement(
              wp,
              { value: sp, style: { width: "110px" } },
          ...
          bt.a.createElement(
            ...
            bt.a.createElement(
              wp,
              { value: "uCenter", onClick: t.handleDropBtnClick },
              o,
              l
            )
          ),
          bt.a.createElement(
            ...
            bt.a.createElement(
              wp,
              { onMouseEnter: t.ins.sync("open", !0) },
              bt.a.createElement(Vr.a, null)
            )
          ),
          bt.a.createElement(
      ...
      const Fp = $a.c.div(
        ...
        Hp = $a.c.div(
          ...
          (e) =>
            Object($a.b)(
              Tp || (Tp = Object(Ya.a)(["display:", ""])),
              e.show ? "block" : "none"
            ),
          (e) =>
            Object($a.b)(
              Vp || (Vp = Object(Ya.a)(["top:", ""])),
              e.top || "60px"
            )
        ),
        Up = $a.c.div(
        ...
        Wp = $a.c.div(
          ...
          (e) =>
            Object($a.b)(
              Pp || (Pp = Object(Ya.a)(["background-image: url(", ")"])),
              e.src
            )
        ),
      ...
      function Yp(e) {
        ...
        return bt.a.createElement(
          "div",
          Object.assign({ className: "gHover" }, l, {
            style: Jp,
            onMouseEnter: t,
            onMouseLeave: a,
          }),
      ...
      function lu(e) {
        ...
        const {
            ...
            settings: n,
            sync: r,
          } = Object(h.useConcent)({ module: "portal", setup: ru }),
          { starAppNames: l, visitAppNames: o, userInfo: c } = a;
        return bt.a.createElement(
          Fp,
          null,
          bt.a.createElement(Wp, {
            className: "gHover",
            src: c.icon,
            onClick: t,
          }),
          ...
          bt.a.createElement(
            ...
            {
              top: "60px",
              show: a.showLatestVisitMenu,
              onMouseLeave: r("showLatestVisitMenu", !1),
            },
            o.map((e) =>
              bt.a.createElement(
                Up,
                ...
                bt.a.createElement(
                  Gp,
                  { "data-name": e, onClick: n.handleItemClick },
                  e
                )
              )
            ),
            bt.a.createElement(zp, {
              setIf: 0 === o.length,
              t: bt.a.createElement(au, {
                "data-path": M,
                keyword: "\u6700\u8fd1\u8bbf\u95ee",
                onClick: n.gotoPage,
              }),
              f: bt.a.createElement(
                Up,
                {
                  "data-path": L,
                  className: "gMenuItemHoverBlue",
                  onClick: n.gotoPage,
                },
                "\u66f4\u591a ..."
              ),
      ...
      var cu = bt.a.memo(() => {
        ...
        return bt.a.createElement(
          ...
          bt.a.createElement(
            "a",
            {
              href: "https://github.com/tnfe/hel",
              target: "_blank",
              rel: "noopener noreferrer",
            },
            "hel-micro"
      ...
      function iu(e) {
        ...
        const n = {
          ...
          seeVersion() {
            n.cancel(),
              a.state.subApp
                && It("openSubAppDrawer", a.state.subApp, "version");
          },
          seeApp() {
            n.cancel(),
              a.state.subApp
                && It("openSubAppDrawer", a.state.subApp, "application");
          },
        };
        return n;
      }
        ...
        pu = bt.a.memo(function () {
          const e = kt(iu),
            ...
            n = [
              bt.a.createElement(
                Ba.a,
                { key: "1", onClick: e.cancel },
                "\u53d6\u6d88"
              ),
              bt.a.createElement(
                Ba.a,
                { key: "2", onClick: e.seeApp },
                "\u67e5\u770b\u5e94\u7528"
              ),
              bt.a.createElement(
                Ba.a,
                { key: "3", onClick: e.seeVersion },
                "\u67e5\u770b\u7248\u672c"
              ),
              t
                ? bt.a.createElement(
                    Ba.a,
                    { key: "4", onClick: () => e.ok(!0) },
                    "\u8bbf\u95ee(\u5f53\u524d\u9875\u7b7e\u6253\u5f00)"
                  )
                : null,
              bt.a.createElement(
                Ba.a,
                { key: "5", type: "primary", onClick: () => e.ok() },
                "\u786e\u8ba4\u8bbf\u95ee"
              ),
            ].filter(Boolean);
          return bt.a.createElement(
      ...
      class mu extends bt.a.Component {
          ...
          super(...arguments),
            ...
            (this.resetSubAppMargin = (e) => {
              ...
              const t = this.ctx.moduleComputed,
                a = window.top.document.querySelector(
                  "#leah-sub-app-container"
                );
              a
                && (t.displaySubAppWithSideBar
                  ? "60px" !== a.style.marginLeft
            ...
            (this.renderSideBar = () =>
              bt.a.createElement(lu, { hideSideBar: this.hideSideBar })),
            (this.renderContent = () => {
            ...
            (this.renderMainContent = () =>
              bt.a.createElement(bt.a.Fragment, null, this.renderAppHub()));
        }
        componentDidMount() {
          this.ctx.mr
            .login()
        ...
        render() {
          return (
            console.log(
              "%c HelApp BuildTime : ".concat("2025/10/22 16:55:08"),
              "color:purple;border:6px solid purple;"
            ),
            bt.a.createElement(
              Nn.BrowserRouter,
              { basename: "__hub" },
      ...
      de.b.config({ duration: 2, top: 38 }),
        (async function () {
          Tn.a.render(
            bt.a.createElement(gu, null),
            document.getElementById("app-manager-root")
          );
        })().catch((e) => {
          console.error(e),
            alert("err: ".concat(e.message, ", contact ").concat(H));
        });
    },
  },
  [[471, 1, 2]],
