...
export type CtxM<P = {}, M extends Modules = MODULE_DEFAULT, Se = {}, RefCu = {}, Ot extends OtherTypes = OtherTypes> = ICtx<
  RootState,
  RootRd,
  RootRdCaller,
  RootRdGhost,
...
export type CtxMS<P = {}, M extends Modules = MODULE_DEFAULT, St = {}, Se = {}, RefCu = {}, Ot extends OtherTypes = OtherTypes> = ICtx<
  RootState,
  RootRd,
  RootRdCaller,
  RootRdGhost,
...
export type CtxSConn<P = {}, St = {}, Conn extends Modules = MODULE_VOID, Se = {}, RefCu = {}, Ot extends OtherTypes = OtherTypes> = ICtx<
  RootState,
  RootRd,
  RootRdCaller,
  RootRdGhost,
...
export type CtxConn<P = {}, Conn extends Modules = MODULE_VOID, Se = {}, RefCu = {}, Ot extends OtherTypes = OtherTypes> = ICtx<
  RootState,
  RootRd,
  RootRdCaller,
  RootRdGhost,
...
export type CtxDe<P = {}, Se = {}, RefCu = {}, Ot extends OtherTypes = OtherTypes> = CtxM<P, MODULE_DEFAULT, Se, RefCu, Ot>;
export type CtxDeS<P = {}, St = {}, Se = {}, RefCu = {}, Ot extends OtherTypes = OtherTypes> = CtxMS<P, MODULE_DEFAULT, St, Se, RefCu, Ot>;
...
export type CtxDeConn<P = {}, Conn extends Modules = MODULE_VOID, Se = {}, RefCu = {}, Ot extends OtherTypes = OtherTypes> = CtxSConn<
  P,
  MODULE_DEFAULT,
  Conn,
  Se,
