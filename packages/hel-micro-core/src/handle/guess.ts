...
function getVerFromAtInMiddle(nameAndVer: string, callerSpecifiedVer?: string): string {
...
function isJs(str: string): boolean {
 ...
 */
export function tryGetVersion(appGroupName: string, platform: string): string {
...
export function tryGetAppName(version: string, appGroupName: string): string {
