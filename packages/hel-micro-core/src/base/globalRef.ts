let globalThisRef: typeof globalThis | null = null;
...
export function setGlobalThis(specGlobalThis: typeof globalThis, merge: boolean = false): void {
  let prevShared = null;
 ...
 * 针对浏览器环境后期可能会调整宿主节点
 */
export function getHelSingletonHost(): typeof globalThis {
