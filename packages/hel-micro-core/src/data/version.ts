...
interface ISubAppVersion {
  version_tag?: string;
  sub_app_version?: string;
  [key: string]: any;
}

export function getVersion(appName: string, options: VersionOptions = {}): any {
...
export function setVersion(appName: string, versionData: ISubAppVersion, options: VersionOptions = {}): void {
