...
interface SetEmitLibOptions {
  appGroupName?: string;
  platform?: string;
}

export function getVerLib(appName: string, inputOptions: InputOptions = {}): any {
...
export function setEmitLib(appName: string, emitApp: IEmitAppInfo, options: SetEmitLibOptions = {}): void {
  ...
  const assignLibObj = (appName: string): void => {
